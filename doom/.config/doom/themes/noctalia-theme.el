...
(let* ((bg "#131312")
      ...
      (on-primary "#2c3322")
      (on-primary-container "#dee6cd")
      (on-secondary "#2f3129")
      (on-secondary-container "#e2e3d8")
      (on-surface "#e5e2df")
      (on-surface-variant "#c6c7bd")
      (on-tertiary "#223430")
      (on-tertiary-container "#d3e7e0")
      (outline-color "#909288")
      (outline-variant "#454840")
      (primary "#c2cab2")
      (primary-container "#424937")
      (secondary "#c6c7bc")
      (secondary-container "#45483f")
      (shadow "#000000")
      (surface "#131312")
      ...
      (tertiary "#b7cbc4")
      (tertiary-container "#384a46")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#b7cbc4")
      (on-success "#223430")
      (success-container "#384a46")
      (on-success-container "#d3e7e0")
      ;; Map fixed colors to regular colors
      (primary-fixed "#c2cab2")
      (primary-fixed-dim "#424937")
      (secondary-fixed "#c6c7bc")
      (secondary-fixed-dim "#45483f")
      (tertiary-fixed "#b7cbc4")
      (tertiary-fixed-dim "#384a46")
      (on-primary-fixed "#2c3322")
      (on-primary-fixed-variant "#dee6cd")
      (on-secondary-fixed "#2f3129")
      (on-secondary-fixed-variant "#e2e3d8")
      (on-tertiary-fixed "#223430")
      (on-tertiary-fixed-variant "#d3e7e0")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e5e2df")
      (inverse-primary "#c2cab2")
      (inverse-surface "#131312")
